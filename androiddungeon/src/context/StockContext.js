...
//     const getProductsByCategory = (productCategoria) => {
//         return new Promise ((resolve) => {
//             // aca va firebase :)
//             setTimeout(() => {
//                 const updatedStock = products.filter(prod => prod.categoria === productCategoria)
//                 setStock(updatedStock)
//                 resolve(updatedStock)
//             }, 500)
//         })
...
//     const removeFromStock = (itemId, quantity) => { 
//         const updatedStock = stockList.map(prod => {
//             if (prod.id === itemId) {
//                 return {...prod, stock: prod.stock - quantity}
//             }
...
//     const addToStock = (itemId, quantity) => { 
//         const updatedStock = stockList.map(prod => {
//             if (prod.id === itemId) {
//                 return {...prod, stock: prod.stock + quantity}
//             }
...
//     const updateStock = (stock, cartContent) => {
//         const updatedStock = stock.map(prod => {
//             const itemInCart = cartContent.find(item => item.id === prod.id)
//             if (itemInCart) {
...
//         })
//         console.log('1',stock);
//         console.log('2', updatedStock);

//             setStock(updatedStock)
//     }
    
//     return (
//         <StockContext.Provider value={{ stockList, getProducts, getProductsById, getProductsByCategory, removeFromStock, addToStock, updateStock }}>
//             {children}
